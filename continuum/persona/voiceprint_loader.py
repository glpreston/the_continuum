...
class VoiceprintLoader:
    ...
    def __init__(self):
        # Always load the active system voiceprint (v2.0 by default)
        self.voiceprint = load_system_voiceprint("latest")
    ...
    def get_actor_voiceprint(self, actor_id: str):
        return VOICEPRINTS.get(actor_id)

    def get_system_voiceprint(self, version: str = "latest"):
        return load_system_voiceprint(version=version)

    def get_active_system_voiceprint(self):
